...
(function () {
    ...
    AppCtrl.prototype.add = function ($scope, name) {
        ...
        var shape = this.CANVAS.SHAPE($scope[name].x || lineX, $scope[name].y || lineY, $scope[name].color, this.draggable, $scope[name].width || this.CANVAS.SIZES[name].width || undefined, $scope[name].height || this.CANVAS.SIZES[name].height || undefined, $scope[name].rotation, $scope[name].name = name, $scope[name].radius, $scope[name].type = type, $scope[name].src, $scope[name].stroke || this.CANVAS.SIZES[name].stroke, $scope[name].strokeWidth || this.CANVAS.SIZES[name].strokeWidth, $scope[name].points);
    ...
    AppCtrl.prototype.update = function ($scope, index) {
        ...
        for (var i = 0; i < this.floors[index].plan.shapes.length; i++) {
            ...
            shapes.push(this.CANVAS.SHAPE(this.floors[index].plan.shapes[i].x, this.floors[index].plan.shapes[i].y, this.floors[index].plan.shapes[i].color, this.draggable, this.floors[index].plan.shapes[i].width, this.floors[index].plan.shapes[i].height, this.floors[index].plan.shapes[i].rotation, this.floors[index].plan.shapes[i].name, this.floors[index].plan.shapes[i].radius, this.floors[index].plan.shapes[i].type, src, this.floors[index].plan.shapes[i].stroke, this.floors[index].plan.shapes[i].strokeWidth, this.floors[index].plan.shapes[i].points));
        }
